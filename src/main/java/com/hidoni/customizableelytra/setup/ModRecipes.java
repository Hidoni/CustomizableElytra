...
public class ModRecipes {
    ...
    public static final RegistryObject<SimpleRecipeSerializer<SplitToWingRecipe>> SPLIT_TO_WING_RECIPE = Registration.RECIPE_SERIALIZERS.register("elytra_wing_split_recipe", () -> new SimpleRecipeSerializer<>(SplitToWingRecipe::new));
