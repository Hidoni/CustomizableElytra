...
public class ModItems {
    ...
    public static final RegistryObject<Item> ELYTRA_WING = Registration.ITEMS.register("elytra_wing", () -> new ElytraWingItem(new Item.Properties().durability(Items.ELYTRA.getMaxDamage(null)).setNoRepair().rarity(Rarity.UNCOMMON)));
