...
public class ModItems {
    ...
    public static final RegistryObject<Item> ELYTRA_WING = Registration.ITEMS.register("elytra_wing", () -> new ElytraWingItem(new Item.Properties().rarity(Rarity.UNCOMMON).tab(ItemGroup.TAB_MISC)));
