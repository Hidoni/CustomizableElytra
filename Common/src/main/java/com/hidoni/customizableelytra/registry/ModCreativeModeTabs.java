...
public class ModCreativeModeTabs {
    public static final RegistryEntry<CreativeModeTab, ? extends CreativeModeTab> CUSTOMIZABLE_ELYTRA_TAB = ModRegistries.CREATIVE_MODE_TABS.register(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "creative_tab"), () -> CreativeModeTab.builder(CreativeModeTab.Row.TOP, 0)
